...
<figure>
  ...
  alt="Figure 3"  style="width:80%">
  <figcaption>Figure 3: Distributions of the important variables for traffic efficiency for the experiments with single driving styles.</figcaption>
</figure>

<figure>
  <img
  src="http://laststriker11.github.io/files/TRProcedia_EWGT2020_fig2.png"
  alt="Figure 4"  style="width:80%">
  <figcaption>Figure 4: Performance comparison of the scenarios of the combination of two driving styles.</figcaption>
</figure>
